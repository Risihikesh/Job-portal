...
import ApplicationForm from "../components/reusable/Form";
import ApplicationModal from "../components/reusable/ApplicationModal";
    ...
    <div className='pt-14 grid grid-cols-12 gap-5'>
      <div className='col-span-9 mb-10'>
        ...
        <div className='space-y-5'>
          ...
          <button  className="flex items-center gap-2 bg-slate-600 w-28 justify-center rounded-md py-2 text-white mt-8" onClick={applyiJob}>Apply</button>
